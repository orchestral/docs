...
for DIR in asset imagine auth debug extension facile foundation html memory model notifier publisher optimize resources support translation testbench view warden widget
do
    cd ../;
    cd $DIR;
    echo '-------';
